        ...
        rx.cond(
            ...
            rx.el.div(
                rx.el.div(
                    ...
                    class_name="bg-[#1a1a2e]/90 backdrop-blur-sm border-4 border-[#00ff9f] p-2 rounded shadow-lg"
                ),
        ...
        rx.cond(
            ...
            rx.el.div(
                rx.el.div(
                    ...
                    class_name="bg-[#1a1a2e]/90 backdrop-blur-sm pixel-border p-3 rounded shadow-xl"
                ),
                class_name="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 whitespace-nowrap z-50"
            ),
            rx.el.div()
...
def interactive_campus_map() -> rx.Component:
    ...
    return rx.el.div(
        ...
        rx.el.div(
            ...
            rx.el.div(
                ...
                rx.cond(
                    ...
                    rx.el.div(
                        ...
                        class_name="flex flex-col items-center justify-center gap-2 px-4 absolute right-4 top-1/2 transform -translate-y-1/2 z-50 bg-[#1a1a2e]/90 backdrop-blur-sm pixel-border rounded p-2"
                    ),
                    rx.fragment()
                ),
            ...
            class_name="w-full pixel-border bg-[#1a1a2e]/40 backdrop-blur-sm p-1"
        ),
